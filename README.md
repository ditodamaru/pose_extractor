...
pose_extractor offers a pose extraction method of tracjectory message data from [tracking_pid](https://github.com/nobleo/tracking_pid) ROS package. This node is subcribe to /trajectory topic which contains ```geometry_msgs/PoseStamped``` and then republish the pose message into /copy_trajectory topic.


**Keywords:** tracking, pid, pose_trajectory
